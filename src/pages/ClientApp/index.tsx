                ...
                <div className="relative mb-6 sm:mb-8 overflow-hidden bg-white/15 rounded-2xl p-4 sm:p-5 shadow-xs border border-white/30">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="bg-white/75 backdrop-blur-md border border-white/80 px-3 py-2 rounded-xl shrink-0 flex flex-col justify-center items-start md:items-end gap-0.5 shadow-xs w-full md:w-auto">
                      ...
                      <strong className="text-sm sm:text-base font-extrabold text-emerald-600 whitespace-nowrap leading-none">
...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <>
      <motion.a
        href={productUrl}
        className="orbi-market-product-card group flex h-full cursor-pointer flex-col overflow-hidden rounded-[1.35rem] border border-slate-200/80 transition-all duration-300 hover:-translate-y-1 hover:border-orange-300/70 snap-start"
