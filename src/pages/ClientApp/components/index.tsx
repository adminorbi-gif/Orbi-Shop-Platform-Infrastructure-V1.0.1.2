...
export function PromoCarousel({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className="w-full max-[720px]:w-[calc(100%+16px)] max-[720px]:-mx-2 sm:max-[720px]:w-[calc(100%+32px)] sm:max-[720px]:-mx-4 min-[720px]:w-[calc(100%-50px)] min-[720px]:mx-auto max-[720px]:aspect-[21/11] min-[720px]:aspect-[5/2] md:aspect-[10/3] lg:aspect-[4/1] max-h-[250px] relative overflow-hidden mb-8 border-none flex items-center justify-center bg-transparent group select-none max-[720px]:rounded-none min-[720px]:rounded-[14px] focus:outline-none"
    >
