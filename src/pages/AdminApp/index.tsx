      ...
      <div className="flex-1 overflow-hidden flex flex-col md:flex-row w-full h-full">
        ...
        <aside className="w-full md:w-64 bg-slate-50 border-r border-slate-200 flex-shrink-0 flex flex-col items-stretch">
          ...
          <div className="hidden md:flex p-6 border-b border-slate-200 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between mt-1 px-2.5 py-1.5 bg-slate-100 border border-slate-200/50 rounded-xl shadow-inner text-[9px] font-black tracking-wide">
              <span className="text-slate-500 uppercase tracking-wider">
                {lang === "sw" ? "Mfumo wa Moja kwa Moja" : "Realtime Engine"}
              </span>
              <div className="flex items-center gap-1.5">
                ...
                <span className={`uppercase text-[8px] font-black tracking-widest ${isWsConnected ? (connectionQuality === "good" ? "text-emerald-700" : "text-amber-700") : "text-rose-700"}`}>
                  {isWsConnected ? (connectionQuality === "good" ? "LIVE" : "LAG") : "OFFLINE"}
                </span>
              </div>
            </div>
          </div>
